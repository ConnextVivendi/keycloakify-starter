...
import { SHOW_LOGOUT_SESSIONS } from "../config";
...
function LogoutOtherSessions(props: { kcClsx: KcClsx; i18n: I18n }) {
    ...
    if (!SHOW_LOGOUT_SESSIONS) {
        return <input type="hidden" name="logout-sessions" value="off" />;
    }
        ...
        <div id="kc-form-options" className={kcClsx("kcFormOptionsClass")}>
            <div className={kcClsx("kcFormOptionsWrapperClass")}>
                <div className="checkbox">
                    <label>
                        <input type="checkbox" id="logout-sessions" name="logout-sessions" value="off" defaultChecked={false} />
