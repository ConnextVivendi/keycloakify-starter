...
const { useI18n, ofTypeI18n } = i18nBuilder
	...
	.withCustomTranslations({
		...
		de: {
			...
			magicLinkSuccessfulLogin: "Authentifizierungssitzung bestätigt. Bitte kehren Sie zum Login-Seiten-Tab zurück.",
			magicLinkFailLogin: "Authentifizierungssitzung abgelaufen. Bitte schließen Sie diesen Tab und starten Sie den Login-Vorgang neu.",
			loginPage: "Login-Seite",
			multipleSessionsError: "Mehrere Login-Sitzungen im selben Browser geöffnet. Bitte schließen Sie sie und starten Sie den Login-Vorgang neu.",
